              ...
              <div className="row g-5 align-items-center">
                <div className="col-lg-5">
                  <div className="section-head text-align-left">
                    <h2 className="section-sub-title tmp-scroll-trigger tmp-fade-in animation-order-1">
                    ...
                    <h3 className="title split-collab tmp-scroll-trigger tmp-fade-in animation-order-2">
                      Building bridges to your future with every detail you share, crafting a path to success together.
                    </h3>
                    <p className="description tmp-scroll-trigger tmp-fade-in animation-order-3">
                      Join our dynamic team by submitting your application today. We’re always looking for passionate, skilled, and motivated individuals who are ready to grow with us. Apply now and take the next step in your career journey.
                    </p>
                  </div>
                </div>
                        ...
                        <div className="contact-form-wrapper row">
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                                ...
                                <select className="select-field" name="gender" id="gender" required>
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input
                                className="input-field"
                                placeholder="E.g. 12th Pass, Graduation, etc."
                                name="qualification"
                                id="qualification"
                                required
                                defaultValue={""}
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                                ...
                                <select className="select-field" name="experience" id="experience" required>
