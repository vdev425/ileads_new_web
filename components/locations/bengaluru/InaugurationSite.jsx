...
import { bengaluruinaguration } from "@/data/portfolio";

export default function Projects({ isLight = false }) {
  return (
    <section className="tmp-latest-portfolio">
      <div className="">
        <h2 className="title">Bengaluru - Inaugration of Second Site</h2>
        <p className="docs mb-5">We are proud to announce the inauguration of our new site in October 2024. This state-of-the-art facility is designed to support our growing operations and provide a productive and collaborative work environment.</p>
        <div className="row">
          {bengaluruinaguration.map((item) => (
            <div
