...
import { gurugramalloverview } from "@/data/portfolio";

export default function Projects({ isLight = false }) {
  return (
    <section className="tmp-latest-portfolio">
      <div className="">
        <h2 className="title">Gurugram - Production Floor</h2>
        ...
        <div className="section-head text-align-left mb--50 mt--50 docs">
                  ...
                  <ul>
                    <li>
                      <strong>Intellect Commerce</strong>
                        ...
                        <ul>
                          ...
                          <li>
                            <h4 className="check-box-item align-items-start fw-normal docs mb--0">
                              ...
                              3x2 layout, offering a spacious and comfortable workspace for employees.
                            </h4>
                          </li>
                        </ul>
                      </div>
